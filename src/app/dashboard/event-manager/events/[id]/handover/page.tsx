        ...
        <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-[var(--secondary-label)]">
                        {language === 'ar' 
                            ? 'نظرة عامة على التسليم وحزمة التدقيق مع قائمة التحقق من الإكمال والوثائق لإغلاق الحدث.'
                ...
                <LiquidGlassCard blurIntensity="lg" className="p-6">
                    <h3 className="text-lg font-semibold text-[var(--label)] mb-4">
                        {language === 'ar' ? 'قائمة التحقق من التسليم' : 'Handover Checklist'}
                    </h3>
                    <div className="space-y-4">
                        <div className="p-4 bg-[var(--system-fill)] rounded-lg">
                            <p className="text-sm text-[var(--secondary-label)]">
                                {language === 'ar' 
                                    ? 'هذه الصفحة قيد التطوير. سيتم إضافة قائمة التحقق من التسليم وحزمة التدقيق قريباً.'
                ...
                <div className="flex gap-4">
                    ...
                    >
                        ...
                        {language === 'ar' ? 'إكمال التسليم' : 'Complete Handover'}
                    </GlassButton>
                </div>
            </div>
    );
