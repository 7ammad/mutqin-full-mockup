...
export default function HcpFilesTab() {
    ...
    // Get view mode from URL or default to tickets
    const urlView = searchParams.get('view') as ViewMode | null;
    const [viewMode, setViewMode] = useState<ViewMode>(urlView === 'certificates' ? 'certificates' : 'tickets');
    ...
    // Process certificates with events (only completed)
    ...
    }, [focusEventId, viewMode, loading, upcomingTickets, pastTickets, certificatesWithEvents]);
    ...
    const handleViewModeChange = (mode: ViewMode) => {
        ...
        if (focusEventId) {
            params.set('eventId', focusEventId);
        }
